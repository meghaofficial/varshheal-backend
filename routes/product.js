...
router.get("/drafted-products", paginate(Product, { status: "draft" }), async (req, res) => {
  return res.json(res.paginationResult);
});
router.get("/published-products", paginate(Product, { status: "published" }), async (req, res) => {
  return res.json(res.paginationResult);
});
router.patch("/update-product", isAuthenticated, isAuthorized, updateProduct);
router.delete("/delete-product", isAuthenticated, isAuthorized, deleteProduct);
